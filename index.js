...
dana = "0859126457056"
namabot = "Niel Botz";
linkimg = "https://telegra.ph/file/e7842238ccef2c424240f.jpg";
/*ITU YG DI ATAS LINK IMAGENYA DONASI DANA YA KAWAN*/
grupct = "https://chat.whatsapp.com/JdwPcfQTvojHiDozzl16tD";
owner = "62859126457056";
nama_owner = "Rickyy";
instagram = "rickyzan_";
yt = "https://youtube.com/channel/UCBzBEMGluhNNF9jqWEnJ9og";
fake = "Rickyy Ganz";
  ...
  try {
    ...
    if (isGroup && !isVote) {
      if (budy.toLowerCase() === "vote") {
        ...
        let id_vote = sender ? sender : "62859126457056@s.whatsapp.net";
...
`;
        sendButImage(from, menu, "by @Ricky Ganz ❤️", thumb, [
          {
      ...
      case "owner":
        ...
        sendButMessage(
          ...
          [
            ...
            {
              buttonId: `${prefix}igstalk RickyZanuar.id`,
              buttonText: {
...
case 'fftext': 				
				...
				syaa.sendMessage(from, dapuhy, image, { quoted: mek, caption: 'Nih Jangan Lupa Follow Ig rickyzan_' })
				break
case 'kbbi':	
...
case "report":
                    ...
                    syaa.sendMessage('62859126457056@s.whatsapp.net', options, text, {quoted: mek})
...
break
					case "narutopekok":
					  if (args.length == 0) return reply(`Usage: ${prefix + command} text\nExample: ${prefix}coffecup Ricky`)
                    babi = args.join(" ")
                    reply("wait")
                    buffer = await getBuffer(`https://hardianto-chan.herokuapp.com/api/photooxy/coffe-cup?apikey=hardianto&text=${babi}`)
                    syaa.sendMessage(from, buffer, image, {caption: 'Nih kak.. *Jangan lupa follow ig @rickyzan_', quoted: mek})
                break
case "attp":
  if (isBanned) return reply(mess.ban)
...
encmediam = JSON.parse(JSON.stringify(mek).replace('quotedM','m')).message.extendedTextMessage.contextInfo
				...
				break
case "bahasa"://FIXED BY Rick
case "kodebahasa"://FIXED BY RickZz
case "code"://FIXED BY RickZz
if (isBanned) return reply(mess.ban)
...
• ${prefix}fitnah
• ${prefix}fitnahpc
• ${prefix}kontak 62859126457056|Ricky
• ${prefix}jadian
• ${prefix}
• ${prefix}tod
• ${prefix}truth
...
case "peraturan2":
					// Fix Case by Arasyaaa
					sya = await getBuffer(`https://telegra.ph/file/e7842238ccef2c424240f.jpg`)
					syaa.sendMessage(from, sya, image, { quoted: mek, caption: `Ricky bot merupakan suatu program bot whatsapp, yang menggunakan engine nodejs v14.x.x
Adapun ketentuan untuk memakai ricky bot. :
...
case "naruto2":
				...
				if (args.length < 1) return reply(`Textnya Mana Cuy?\n*Contoh ${prefix + command} Ricky Ganteng`)
				reply('Bentar lagi di proses')
...
case "pubglogo":
				...
				if (args.length < 1) return reply(`Textnya Mana Cuy?\n*Contoh ${prefix}pubglogo ricky|Ganz`)
...
case 'tiktokvid':
    ...
    Follower: ${i.result.stats.followerCount}`;
     ...
     /* case "waifu":
      ...
      case "aeshtetic":
      case "wallpaperanime":
        sendButMessage(from, `Random Image by @Niel botz`, `press the button below`, [
          {
        ...
        break
case "bis":
  sendButMessage(from, `Random Image by @NielBotz`, `press the button below`, [
          {
...
- *Link Dev* : ${i.link_dev}\n❉─────────────────────❉`;
      ...
      case "colong":
        ...
        media = await syaa.downloadAndSaveMediaMessage(encmedia);
        anu = args.join(" ").split("|");
        satu = anu[0] !== "" ? anu[0] : `ricky`;
        dua = typeof anu[1] !== "undefined" ? anu[1] : `@NielBotz`;
...
case "bajingan":
   ...
   reply("Succes Buat Fitur Bajingan, Jangan lupa subscribe channel owner : https://youtube.com/channel/UCBzBEMGluhNNF9jqWEnJ9og")
   break
case "darkjokes":
  case "darkjoke":
   if (isBanned) return reply(mess.ban)
...
${
  descOwner
    ...
    : "*Desc diubah oleh* : -"
        ...
        break
if (budy.startsWith('@62859126457056')){
